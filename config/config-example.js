/**
 * EXAMPLE CUSTOM publiclabBOT CONFIGURATION — publiclab
 *
 * See https://github.com/publiclab/publiclabbot/wiki/configuration for detailed
...
exports.activity = {
  ...
  check: {
    repositories: [
      "publiclab/publiclab",
      "publiclab/python-publiclab-api",
      "publiclab/publiclab-electron",
      "publiclab/publiclab-terminal",
      "publiclab/publiclabbot"
    ],
    interval: 6,
    reminder: 10,
    limit: 4
