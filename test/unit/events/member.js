...
const payload = {
  action: "removed",
  repository: {
    full_name: "publiclab/publiclabbot"
  },
  member: {
    login: "octokitten"
  }
...
test("Assign successfully if invite was found", async t => {
  client.invites.set("octokitten@publiclab/publiclabbot", 69);
  ...
  t.equals(client.invites.has("octokitten@publiclab/publiclabbot"), false);
